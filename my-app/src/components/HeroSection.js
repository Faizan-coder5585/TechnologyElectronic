...
<div className="relative z-20 h-full flex items-center justify-center px-4">
  {/* Inner Wrapper for content + line */}
  <div className="relative w-full max-w-5xl flex items-center">
    
    {/* Decorative Line Box - Now aligned to content */}
    <div className="absolute -top-[7] left-10 h-[155%] w-[90px] border-l-4 border-t-4 border-b-4 border-white pointer-events-none" />

    {/* Content */}
    <div className="ml-[100px] max-w-2xl text-white animate__animated animate__fadeInUp">
      <h1 className="text-3xl md:text-5xl font-bold mb-2">
        Driving The New <br /> Future of Mobility
      </h1>
