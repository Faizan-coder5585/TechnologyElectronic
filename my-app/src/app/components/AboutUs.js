    ...
    <section className="relative w-full bg-white py-12 px-4 md:px-16">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        >
          ...
          <div
            className="hidden md:block absolute top-2/3 -translate-y-1/2 right-[15px] w-[216px] bg-blue-900 text-white px-[20px] py-[15px] pr-[80px] shadow-xl  z-10"
            data-aos="fade-up"
          ...
          >
            ...
            <div className="absolute top-[14%] right-[25px] h-[75%] w-[45px] border-r-4 border-t-4 border-b-4 border-white pointer-events-none"></div>
          </div>
        ...
        >
          ...
          <a
            href="/about"
            className="inline-flex items-center font-semibold text-blue-700 group"
          >
            Read More
            <img
