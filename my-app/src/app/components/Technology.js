        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {[
            ...
            },
            {
              title: "Autonomous",
              text:
                "Ushering in a new era of accessible and dependable smart mobility with autonomous driver assistance systems...",
              img: "/technology-2.jpg",
              link: "/technology/pace#autonomous",
            },
            {
              title: "Connected",
              text:
            ...
            >
              ...
              <div className="relative overflow-hidden z-10 py-5">
                {/* Hover Overlay */}
                <div className="absolute inset-0 bg-blue-100 translate-y-[-100%] group-hover:translate-y-0 transition-transform duration-500 ease-in-out z-0 pointer-events-none"></div>
                ...
                <div className="relative z-10 pl-50">
                  ...
                  <a
                    href={link}
                    className="inline-flex items-center text-blue-700 font-semibold opacity-0 translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-500 ease-in-out"
                  >
                    Read More
                    <img
